const list_giaovien = [
    ...
    // { id: 15, 'name': 'Trần Nhật Nam', 'link': 'trannhatnam.html' },
    // { id: 16, 'name': 'Huỳnh Tấn Phát', 'link': 'huynhtanphat.html' },
    // { id: 17, 'name': 'Hoàng Mạnh Hùng', 'link': 'hoangmanhhung.html' },
    // { id: 18, 'name': 'Trần Thị Diễm', 'link': 'tranthidiem.html' },
    // { id: 19, 'name': 'Lê Thị Tố Thi', 'link': 'lethitothi.html' },
