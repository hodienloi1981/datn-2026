const list_doan = [
    ...
    { id: 29, name: 'XÂY DỰNG SÀN GIAO DỊCH BẤT ĐỘNG SẢN THÔNG MINH ĐA NỀN TẢNG THEO KIẾN TRÚC MICROSERVICE, TRIỂN KHAI BẰNG DOCKER', teacher: 'Huỳnh Tấn Phát', 'link': 'huynhtanphat.html', number: 4 },
    { id: 30, name: 'XÂY DỰNG HỆ THỐNG HỌC TẬP TRỰC TUYẾN CÁ NHÂN HÓA CHO LẬP TRÌNH VIÊN THEO KIẾN TRÚC MICROSERVICE, TRIỂN KHAI BẰNG DOCKER', teacher: 'Huỳnh Tấn Phát', 'link': 'huynhtanphat.html', number: 4 },
    {
        id: 31,
